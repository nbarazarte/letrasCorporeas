          ...
          <div class="card-body" style="background-color: #D3D3D3">
            ...
            <div class="cc-selector">
              ...
              <figure class="figure">
                ...
                <input onclick="" type="radio" name="separacionAcero" id="sinSeparacion2" value="sinSeparacion" checked onchange="deshabiltarBotonCart()" > 
              ...
              <figure class="figure">
                ...
                <input  onclick="" type="radio" name="separacionAcero" id="a1cm2" value="a1cm" onchange="deshabiltarBotonCart()"> 
              ...
              <figure class="figure">
                ...
                <input onclick="" type="radio" name="separacionAcero" id="a3cm2" value="a3cm" onchange="deshabiltarBotonCart()"> 
           ...
           <label>Opciones</label>
            <div class="cc-selector">
              ...
              <figure class="figure">
                ...
                <input onclick="" type="radio" name="opcionesAcero" id="sinLuz2" value="sinLuz" checked onchange="deshabiltarBotonCart()">
              ...
              <figure class="figure">
                ...
                <input onclick="" type="radio" name="opcionesAcero" id="iluminacionFrontal2" value="iluminacionFrontal" onchange="deshabiltarBotonCart()">
