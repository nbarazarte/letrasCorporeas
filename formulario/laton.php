           ...
           <label>Opciones</label>
            <div class="cc-selector">
              ...
              <figure class="figure">
                ...
                <input onclick="separacionForm('separacionFormLaton','false');colorLedForm('colorLedFormLaton','false');" type="radio" name="opcionesLaton" id="iluminacionFrontal3" value="Iluminación Frontal" onchange="deshabiltarBotonCart()">
           ...
           <label>Color de Led</label>
            <div class="cc-selector">
              ...
              <figure class="figure">
                ...
                <input onclick="" type="radio" name="colorLedLaton" id="blancoFrioLaton" value="Blanco Frío" checked onchange="deshabiltarBotonCart()">
              ...
              <figure class="figure">
                ...
                <input onclick="" type="radio" name="colorLedLaton" id="blancoCalidoLaton" value="Blanco Cálido" onchange="deshabiltarBotonCart()">  
